    ...
    <section className="bg-[#F5F7FA]">
      ...
      >
        ...
        >
          ...
          <div
            suppressHydrationWarning
            className="mt-8 h-auto sm:h-[80px] bg-white rounded-lg shadow-md flex flex-col sm:flex-row gap-4 sm:gap-2 items-center"
          >
            <CustomDropdown
              className="sm:flex-[2]"
              options={[
      ...
      <div className="mt-8 pb-10 w-full text-[#FF5F6B] font-bold text-center flex justify-center items-center sm:text-[16px] lg:text-[33px] lg:text-left tracking-wide uppercase">
        <div className="flex items-center justify-center lg:justify-start gap-2">
          ...
          <span className="text-xl">
            <img alt="arrow" src="/HomePage/arrows.svg" />
          </span>
        </div>
      </div>
    </section>
